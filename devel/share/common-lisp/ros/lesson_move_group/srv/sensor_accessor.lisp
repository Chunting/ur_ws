...
(cl:in-package lesson_move_group-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <sensor_accessor-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sensor_accessor-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lesson_move_group-srv:<sensor_accessor-request> is deprecated: use lesson_move_group-srv:sensor_accessor-request instead.")))

(cl:ensure-generic-function 'command_id-val :lambda-list '(m))
(cl:defmethod command_id-val ((m <sensor_accessor-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lesson_move_group-srv:command_id-val is deprecated.  Use lesson_move_group-srv:command_id instead.")
  (command_id m))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <sensor_accessor-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lesson_move_group-srv:command-val is deprecated.  Use lesson_move_group-srv:command instead.")
  (command m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<sensor_accessor-request>)))
  ...
  "lesson_move_group/sensor_accessorRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'sensor_accessor-request)))
  "Returns string type for a service object of type 'sensor_accessor-request"
  "lesson_move_group/sensor_accessorRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <sensor_accessor-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sensor_accessor-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lesson_move_group-srv:<sensor_accessor-response> is deprecated: use lesson_move_group-srv:sensor_accessor-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <sensor_accessor-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lesson_move_group-srv:success-val is deprecated.  Use lesson_move_group-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'res-val :lambda-list '(m))
(cl:defmethod res-val ((m <sensor_accessor-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lesson_move_group-srv:res-val is deprecated.  Use lesson_move_group-srv:res instead.")
  (res m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<sensor_accessor-response>)))
  ...
  "lesson_move_group/sensor_accessorResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'sensor_accessor-response)))
  "Returns string type for a service object of type 'sensor_accessor-response"
  "lesson_move_group/sensor_accessorResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'sensor_accessor)))
  ...
  "lesson_move_group/sensor_accessor")